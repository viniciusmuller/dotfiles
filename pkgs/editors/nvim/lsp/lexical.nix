...

{
  programs.neovim.extraConfig = prelude.mkLuaCode ''
    ...
    if vim.fn.getcwd() == "/home/vini/projects/elixir/open-source/lexical" then 
      cmd = "/home/vini/projects/elixir/open-source/lexical/_build/dev/rel/lexical/start_lexical.sh"
    else
      cmd = "/home/vini/projects/elixir/open-source/lexical/_build/prod/rel/lexical/start_lexical.sh"
    end
